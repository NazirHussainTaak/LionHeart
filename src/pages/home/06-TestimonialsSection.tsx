  ...
  <Card className="card-elevated overflow-hidden rounded-3xl border bg-white text-neutral-900 shadow-sm transition-shadow hover:shadow-md dark:border-white/10 dark:bg-neutral-900 dark:text-neutral-100">
    ...
    <div className="relative h-56 md:h-72 select-none">
      ...
      <div className="absolute left-6 bottom-6">
        ...
        <h3 className="font-heading text-2xl font-extrabold text-white drop-shadow md:text-3xl">{company}</h3>
    ...
    >
      <div className="container-width">
        ...
        <div className="mb-16 text-center">
          <h2 id="testimonials-heading" className="mb-4 font-heading text-3xl font-bold md:text-4xl">
            {heading}
          </h2>
        ...
        {/* Carousel */}
        <div className="relative mx-auto max-w-[820px] touch-pan-y">
          <Carousel
            setApi={setApi}
            className="w-full"
            opts={{
          ...
          >
            {/* spacing classes recommended by shadcn */}
