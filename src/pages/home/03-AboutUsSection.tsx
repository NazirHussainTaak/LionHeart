...
const AboutUsSection: React.FC = () => {
  ...
  return (
    <section
      ...
      dir={isAr ? "rtl" : "ltr"}
    >
      <div className="container-width grid items-start gap-12 lg:grid-cols-[0.8fr_1.2fr]">
        {/* Left: CEO card */}
        <figure className={`relative mx-auto max-w-sm ${isAr ? "lg:mx-auto" : "lg:mx-0"}`}>
          <img
            src={ceoPortrait}
          ...
          {/* Speech / bio card */}
          <figcaption className="relative mt-6 rounded-2xl bg-primary p-6 text-white shadow-lg">
            <span
              aria-hidden="true"
