...
const LeaderCard: React.FC<LeaderI18n> = ({ id, name, title, email, phone, blurb }) => (
  <Card className="card-elevated text-center bg-white text-neutral-900 dark:bg-neutral-900 dark:text-neutral-100 transition-shadow hover:shadow-md">
    <CardContent className="pt-8">
      ...
      <p className="text-boulder text-sm leading-relaxed dark:text-zinc-400">{blurb}</p>
